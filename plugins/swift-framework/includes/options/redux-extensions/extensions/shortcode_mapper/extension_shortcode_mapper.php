...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_extension_shortcode_mapper' ) ) {
     ...
     * @since       3.1.6
     */
    class ReduxFramework_extension_shortcode_mapper extends ReduxFramework {
        ...
        */
        public function __construct( $parent ) {
            ...
            $this->field_name = 'shortcode_mapper';
