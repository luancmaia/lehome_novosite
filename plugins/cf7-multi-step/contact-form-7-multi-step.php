...
Plugin URI: Plugin URI: https://ninjateam.org/contact-form-7-multi-step/
...
function cf7mls_premium_only($type, $echo = true)
{
    $link = 'http://goo.gl/LfLf2h';
    $html = '';
    if ($type == 'button') {
        $html = sprintf(
        ...
        $img_url = CF7MLS_PLUGIN_URL . '/assets/admin/img/contact-form-7-multi-step-pro.png';
        $html = sprintf(
